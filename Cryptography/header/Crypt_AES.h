...
/*const DE-B-BOX*/
const uint8_t DE_S_BOX[0x10][0x10] =
{
...
template <size_t T1, size_t T2>
void AddRoundKey(uint8_t P_BOX[4][4], uint8_t(&KEY_BOX)[T1][T2], int round = 0);
...
string initial();
string simple_AES(string text, string key, uint8_t mod);
